...
const PopularTags = () => {
  return (
    <div className="p-4 rounded-2xl border-[1px] border-blue-500 flex flex-col gap-4 ml-3">
      ...
      <div className="flex gap-4">
        <div className="relative w-20 h-20 rounded-xl overflow-hidden">
          <Image
            path="general/violence_event.jpg"
            alt="event"
            w={120}
            h={120}
            tr={true}
      ...
      <div className="">
        <div className="flex items-center justify-between">
          ...
          <Image path="icons/R.jpg" alt="info" w={16} h={16} />
        </div>
